    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Notifications */}
          <button
            onClick={() => alert('No new alerts. All tourism routes and railway lines are operational.')}
            className="relative p-2 rounded-xl bg-parchment-100/80 border border-parchment-300 text-charcoal-light hover:text-charcoal"
          >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-charcoal-light mt-1 font-medium">
                    Explore curated heritage monuments, ancient caves, and verified multi-modal routes.
                  </p>
                </div>

                {/* 4 Stats Chips matching Image 2 */}
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div className="px-3 py-1.5 rounded-xl bg-slate-950/80 backdrop-blur-md border border-parchment-300 text-xs text-charcoal">
                    <span className="font-bold text-amber-400 mr-1">42</span> Heritage Sites
                  </div>
                  <div className="px-3 py-1.5 rounded-xl bg-slate-950/80 backdrop-blur-md border border-parchment-300 text-xs text-charcoal">
                    <span className="font-bold text-blue-400 mr-1">28</span> Museums
                  </div>
                  <div className="px-3 py-1.5 rounded-xl bg-slate-950/80 backdrop-blur-md border border-parchment-300 text-xs text-charcoal">
                    <span className="font-bold text-cyan-400 mr-1">18</span> Coastal Sites
                  </div>
                </div>
              </div>
            </div>
